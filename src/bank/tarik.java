    ...
    public void ambil(int tab, int t)
    {
        ...
        else
        {
            if(t>tab)
                ...
                JOptionPane.showMessageDialog(null, "Besaran minimal pengambilan tunai adalah Rp50000,00", "Transaksi Gagal", 0);
            else
            {
                saldo = tab-t;
                JOptionPane.showMessageDialog(null, "Saldo Anda saat ini sebesar : " + saldo);
                if(tab<=50000)
                    JOptionPane.showMessageDialog(null, "Saldo minimal harus Rp50000,00 , Segera lakukan penyetoran untuk menghindari penutupan akun!", "CAUTION", 2);
            }
        }
    }
    public int getsaldo()
